...
class Maincontroller(QMainWindow):
    ...
    def __init__(self, folder):
        ...
        self.ui.setupUi(self)
        self.folder = folder
        self.connection = "Column_Endplate"
        self.get_columndata()
        ...
        self.ui.combo_bolt_diameter.currentIndexChanged[str].connect(self.bolt_hole_clearance)
        self.ui.combo_bolt_grade.currentIndexChanged[str].connect(self.call_bolt_fu)
    ...
    def get_user_inputs(self):
        ...
        uiObj["Bolt"]["Type"] = self.ui.combo_bolt_type.currentText()
    ...
    def set_dict_touser_inputs(self, uiObj):
        ...
        if uiObj is not None:
            if uiObj["Connection"] != "Column_Endplate":
            ...
            self.ui.combo_bolt_diameter.setCurrentIndex(self.ui.combo_bolt_diameter.findText(uiObj["Bolt"]["Diameter (mm)"]))
    ...
    def validate_inputs_on_design_btn(self):
        ...
        if self.ui.combo_plateThick.currentIndex() == 0:
            incomplete_list.append("End splice plate thickness")

        if self.ui.combo_weldSize_web.currentIndex() == 0 and self.ui.combo_weld_method.currentIndex() == 1:
            incomplete_list.append("Web weld thickness")

        if self.ui.combo_weldSize_flange.currentIndex() == 0 and self.ui.combo_weld_method.currentIndex() == 1:
    ...
    def display_output(self, outputObj):
        ...
        self.ui.txt_plateheight.setText(str(plate_height))
        ...
        weld_flange = resultObj["Weld"]["Flange"]
        self.ui.txt_weldsize_2.setText(str(weld_flange))
    ...
    def reset_btnclicked(self):
        ...
        self.ui.txt_plateheight.clear()
        self.ui.txt_platewidth.clear()
        self.ui.txt_platethickness.clear()

        self.ui.txt_stiffheight.clear()
        self.ui.txt_stiffwidth.clear()
        self.ui.txt_stiffthickness.clear()

        self.ui.txt_weldsize_2.clear()
        self.ui.txt_weldsize_web.clear()
    ...
    #    """
    #    self.alist = self.designParameters()
    #    self.result_obj = ccEndPlateSplice(self.alist)
...
def launch_column_endplate_controller(osdagMainWindow, folder):
    set_osdaglogger()
